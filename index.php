		...
		{	//쿼리가 성공적으로 전송 되었으면
			...
			{ //해시코드에 대한 데이터가 등록 되어 있으면
				...
				echo "
					...
					<meta property='og:description' content='URL is Shortened by solt.pw' />
					<meta property='og:image' content='https://cdn.pixabay.com/photo/2014/02/23/18/59/salt-273105_1280.jpg' />
				";
